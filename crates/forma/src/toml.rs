...
"#,
        ...
        assert_eq!(
            ...
            "{dates: ['LocalDate(\"1979-05-27\"), 'LocalTime(\"07:32:00.1200\")], owner: {name: \"Ada\"}, point: {x: 1, y: 2}, products: [{name: \"one\"}, {name: \"two\"}], title: \"Forma\", when: 'OffsetDateTime(\"1979-05-27T07:32:00Z\")}"
        );
    }
