...
fn load_synthetic_entry_with_native_modules(
    ...
    let main_module = resolver
        ...
        .map_err(|error| ModuleError::new(error.to_string()))?;
    if main_module.format != ModuleFormat::Forma {
...
impl ModuleLoader {
    ...
    fn compile_xl(
        ...
        module_source: FormaModuleSource<'_>,
