...
XL supports explicit partial application by placing placeholders in the direct
argument slots of a call:
...
The lexer recognizes two dedicated token categories:
...
Identifier's text whether it is a placeholder.

## Call-section syntax

A placeholder is accepted only as a direct argument of a call expression:
...
- placeholder outside a direct call argument;
...
1. Add dedicated lossless lexer tokens and grammar slots for direct call
   placeholders.
